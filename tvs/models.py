...
class Volunteer(models.Model):
    ...
    contact = models.CharField(validators=[reg], max_length=17, blank=True)
    ...
    education = models.CharField(max_length=20, choices=CERT,null = True)
    school = models.CharField(max_length=100,blank=True)
    ward = models.CharField(max_length=150,blank=True,null = True)
    city1 = models.CharField(max_length=150,blank=True,null = True)
    council1 = models.CharField(max_length=150,blank=True,null = True)
    ward1 = models.CharField(max_length=150,blank=True,null = True)
    School1 = models.CharField(max_length=150,blank=True,null = True)
    ptr1 = models.CharField(max_length=100, blank=True)
    city2 = models.CharField(max_length=150,blank=True,null = True)
    council2 = models.CharField(max_length=150,blank=True,null = True)
    School2 = models.CharField(max_length=150,blank=True,null = True)
    ptr2 = models.CharField(max_length=100, blank=True)
    ward2 = models.CharField(max_length=150,blank=True,null = True)
    city3 = models.CharField(max_length=150,blank=True,null = True)
    council3 = models.CharField(max_length=150,blank=True,null = True)
    ward3 = models.CharField(max_length=150,blank=True,null = True)
    School3 = models.CharField(max_length=150,blank=True,null = True)
    ptr3 = models.CharField(max_length=100, blank=True)
    def __str__(self):
