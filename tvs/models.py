...
class Volunteer(models.Model):
    ...
    city1 = models.CharField(max_length=150,blank=True)
    council1 = models.CharField(max_length=150,blank=True)
    ward1 = models.CharField(max_length=150,blank=True)
    School1 = models.CharField(max_length=150,blank=True)
    city2 = models.CharField(max_length=150,blank=True)
    council2 = models.CharField(max_length=150,blank=True)
    School2 = models.CharField(max_length=150,blank=True)
    ward2 = models.CharField(max_length=150,blank=True)
    city3 = models.CharField(max_length=150,blank=True)
    council3 = models.CharField(max_length=150,blank=True)
    ward3 = models.CharField(max_length=150,blank=True)
    School3 = models.CharField(max_length=150,blank=True)
